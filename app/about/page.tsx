  ...
  return (
    <div className="flex flex-col items-center w-full overflow-x-hidden">
      ...
      <section className="w-full px-5 sm:px-8 md:px-16 lg:px-24 pb-16 sm:pb-20">
        <div className="card-premium rounded-2xl sm:rounded-3xl px-6 sm:px-10 md:px-16 py-10 sm:py-14 bg-gradient-to-br from-indigo-50 via-white to-purple-50 dark:from-indigo-950/40 dark:via-gray-900 dark:to-purple-950/40 text-center relative overflow-hidden">
          ...
          {/* <div className="w-14 h-14 bg-indigo-100 dark:bg-indigo-900/50 rounded-2xl flex items-center justify-center mx-auto mb-5">
          ...
          <p className="text-base sm:text-lg md:text-xl text-gray-600 dark:text-gray-400 max-w-5xl mx-auto leading-relaxed">
      ...
      <section className="w-full px-5 sm:px-8 md:px-16 lg:px-24 pb-16 sm:pb-20">
        <div className="text-center mb-10 sm:mb-14">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold mb-3 text-gray-900 dark:text-white">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-8">
          ...
          <div className="card-premium btn-animate group cursor-default">
            ...
            <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3 text-gray-900 dark:text-white">User Management</h3>
          ...
          <div className="card-premium btn-animate group cursor-default">
            ...
            <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3 text-gray-900 dark:text-white">Telegram Integration</h3>
            <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400 leading-relaxed">
          ...
          <div className="card-premium btn-animate group cursor-default">
            ...
            <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3 text-gray-900 dark:text-white">Secure by Default</h3>
            <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400 leading-relaxed">
          ...
          <div className="card-premium btn-animate group cursor-default">
            ...
            <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3 text-gray-900 dark:text-white">Built for Speed</h3>
            <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400 leading-relaxed">
          ...
          <div className="card-premium btn-animate group cursor-default">
            ...
            <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3 text-gray-900 dark:text-white">MSME Focused</h3>
            <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400 leading-relaxed">
          ...
          <div className="card-premium btn-animate group cursor-default">
            ...
            <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3 text-gray-900 dark:text-white">Smart Reminders</h3>
            <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400 leading-relaxed">
      ...
      <section className="w-full px-5 sm:px-8 md:px-16 lg:px-24 pb-16 sm:pb-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 sm:gap-8 text-center">
          ...
          <div className="card-premium group cursor-default">
            ...
            <h3 className="text-lg sm:text-xl font-bold mb-2 text-gray-900 dark:text-white">Trust</h3>
            <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400 leading-relaxed">
          ...
          <div className="card-premium group cursor-default">
            ...
            <h3 className="text-lg sm:text-xl font-bold mb-2 text-gray-900 dark:text-white">Simplicity</h3>
            <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400 leading-relaxed">
          ...
          <div className="card-premium group cursor-default">
            <div className="text-4xl sm:text-5xl mb-4">🚀</div>
            <h3 className="text-lg sm:text-xl font-bold mb-2 text-gray-900 dark:text-white">Growth</h3>
            <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400 leading-relaxed">
